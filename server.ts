...
async function startServer() {
  ...
  app.post('/api/stripe/webhook',
    ...
    (req: Request, res: Response) => {
      ...
      if (type === 'checkout.session.completed') {
        ...
        // TODO: Update order status in your database here (verify stripeAmt matches stored order)
    ...
    async (req: Request, res: Response) => {
      ...
      if (webhookId && receivedSig && certUrl && transmissionId) {
        try {
          ...
          // Continue processing if cert fetch fails (non-critical in sandbox)
        }
      } else {
      ...
      if (eventType === 'CHECKOUT.ORDER.APPROVED') {
        ...
        // TODO: capture the order via /api/paypal/capture-order and update DB
        ...
        // TODO: update order as paid in database here
  ...
  app.post('/api/razorpay/webhook',
    ...
    (req: Request, res: Response) => {
      ...
      if (eventAcc === 'payment.captured') {
        ...
        const orderId  = entity.order_id || entity.description || '';
  ...
  app.post('/api/sslcommerz/ipn', async (req: Request, res: Response) => {
    ...
    const orderId = String(body.tran_id || body.value_a || '');
    ...
    try {
      ...
      if (verified && status === 'VALID') {
        ...
        const sslTranId = String(body.tran_id || body.value_a || '');
        ...
        // TODO: update order as paid in database here (verify amount matches stored order)
      }
    } catch (err: any) {
