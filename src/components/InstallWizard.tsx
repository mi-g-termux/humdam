            ...
            <div className="rounded-xl border-2 border-emerald-500 overflow-hidden">
              ...
              <div className="bg-emerald-500 px-4 py-3 flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <span className="text-white font-bold text-sm">⚡ Required: Run this SQL in Supabase first</span>
                </div>
                <span className="text-emerald-100 text-[10px] font-medium">SQL Editor → New query → Run</span>
              </div>
              {/* Steps */}
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="rounded-xl border-2 border-amber-400 overflow-hidden">
              <div className="bg-amber-500 px-4 py-3 flex items-center justify-between">
                <span className="text-white font-bold text-sm">🔥 Step 1: Publish Firestore Rules</span>
                <span className="text-amber-100 text-[10px] font-medium">Firestore → Rules tab → Publish</span>
              </div>
            ...
            <div className="rounded-xl border-2 border-orange-400 overflow-hidden">
              <div className="bg-orange-500 px-4 py-3 flex items-center justify-between">
                <span className="text-white font-bold text-sm">🗄️ Step 2: Publish Storage Rules</span>
                <span className="text-orange-100 text-[10px] font-medium">Storage → Rules tab → Publish</span>
              </div>
